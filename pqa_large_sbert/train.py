...
valid_p_embeddings = pickle.load( open( "valid_p_large_embeddings.pickle", "rb" ) )
valid_q_embeddings = pickle.load( open( "valid_q_large_embeddings.pickle", "rb" ) )
valid_a_embeddings = pickle.load( open( "valid_a_large_embeddings.pickle", "rb" ) )
...
def get_val_loss(vocab, args, model, ep):
    ...
    for ids, posts, questions, answers, labels in batch_iter(val_ids, \
        ...
        #    with open('valid_p_large_embeddings.pickle', 'wb') as b:
        #        pickle.dump(valid_p_embeddings, b)
        #    with open('valid_q_large_embeddings.pickle', 'wb') as b:
        #        pickle.dump(valid_q_embeddings, b)
        #    with open('valid_a_large_embeddings.pickle', 'wb') as b:
