...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_dir", type=str, default="../models/bert_pqa/base/")
    parser.add_argument("--model_path", type=str, default="../models/bert_pqa/base/model.pkl")
    parser.add_argument("--model_save_path", type=str, default="../models/bert_pqa/base/model.pkl")
